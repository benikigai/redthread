...
- [x] Task 3: Mock CRM + flight tool (src/lib/{crm,flight}.ts) — SIMPLE
- [x] Task 4: Tool dispatcher + Claude tool declarations (src/lib/tools.ts) — MODERATE
- [ ] Task 5: Real agent loop replacing stub (src/app/api/agent/route.ts) — COMPLEX
- [ ] Task 6: ElevenLabs voice route (src/app/api/voice/route.ts) — SIMPLE
- [ ] Task 7: agent.json static file (public/.well-known/agent.json) — SIMPLE
